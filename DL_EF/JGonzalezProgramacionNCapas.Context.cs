...
namespace DL_EF
{
    ...
    public partial class JGonzalezProgramacionNCapasEntities : DbContext
    {
        public JGonzalezProgramacionNCapasEntities()
            : base("name=JGonzalezProgramacionNCapasEntities")
        {
        }
        ...
        public virtual int AseguradoraAdd(string nombre, Nullable<byte> idUsuario)
        {
        ...
        public virtual int AseguradoraUpdate(Nullable<int> idAseguradora, string nombre, Nullable<byte> idUsuario)
        {
            var idAseguradoraParameter = idAseguradora.HasValue ?
                new ObjectParameter("IdAseguradora", idAseguradora) :
                new ObjectParameter("IdAseguradora", typeof(int));
        ...
        public virtual int DependienteAdd(string numeroEmpleado, string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, Nullable<int> idEstadoCivil, string sexo, string telefono, string rFC, Nullable<int> idDependienteTipo)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DependienteAdd", numeroEmpleadoParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, fechaNacimientoParameter, idEstadoCivilParameter, sexoParameter, telefonoParameter, rFCParameter, idDependienteTipoParameter);
        }
        ...
        public virtual int DependienteUpdate(Nullable<int> idDependiente, string numeroEmpleado, string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, Nullable<int> idEstadoCivil, string sexo, string telefono, string rFC, Nullable<int> idDependienteTipo)
        {
            var idDependienteParameter = idDependiente.HasValue ?
                new ObjectParameter("IdDependiente", idDependiente) :
                new ObjectParameter("IdDependiente", typeof(int));
        ...
        public virtual int UsuarioAdd(string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, string sexo, string telefono, string userName, string password, string email, string celular, string cURP, Nullable<byte> idRol, string imagen, string calle, string numeroExterior, string numeroInterior, Nullable<int> idColonia)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioAdd", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, fechaNacimientoParameter, sexoParameter, telefonoParameter, userNameParameter, passwordParameter, emailParameter, celularParameter, cURPParameter, idRolParameter, imagenParameter, calleParameter, numeroExteriorParameter, numeroInteriorParameter, idColoniaParameter);
        }
    
        public virtual int UsuarioChangeStatus(Nullable<byte> idUsuario, Nullable<bool> status)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(byte));
        ...
        public virtual ObjectResult<UsuarioGetById_Result> UsuarioGetById(Nullable<byte> idUsuario)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(byte));
        ...
        public virtual int UsuarioUpdate(Nullable<byte> idUsuario, string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, string sexo, string telefono, string userName, string password, string email, string celular, string cURP, Nullable<byte> idRol, string imagen, string calle, string numeroExterior, string numeroInterior, Nullable<int> idColonia)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(byte));
